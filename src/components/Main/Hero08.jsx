...
function Hero08() {
    return (
        <div className='bg-white h-auto px-20 p-4  m-auto'>
            <div className='text-center py-8'>
                <h2 className='GradientText md:text-6xl text-3xl mb-2'>Specialization
                </h2>
                <p className='text-sm  md:text-base '>AREAS THAT WE SPECIALIZE IN TO PROVIDE HOLISTIC SOLUTION TO OUR CLIENTS</p>
            </div>
            <div>
                <div className='flexi  gap-8'>
