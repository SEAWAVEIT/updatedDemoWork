...
function Hero09() {
  ...
  return (
    <div className="py-4 bg-white">
      <div className="max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col justify-between">
              ...
              {faqs.map((faq, index) => (
                <li key={index} className="text-left mb-10">
                  <div className="flex flex-row items-start mb-5">
                    ...
                    <div className="bg-gray-100 p-5 px-12 w-full flex items-center">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-12 w-full flex items-center">
